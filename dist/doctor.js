...
const knownModels = new Set(Object.keys(agentsDefaults.models ?? {}));
// Add the primary default too
const primaryModel = agentsDefaults.model?.primary;
if (primaryModel)
    knownModels.add(primaryModel);
const issues = [];
function checkModel(modelValue, location, fixable) {
